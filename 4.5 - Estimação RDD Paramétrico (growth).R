############################################################################################################
#                                   ANÁLISE EMPÍRICA - ESTIMAÇÃO OLS E EFEITOS FIXOS (GROWTH)
############################################################################################################
...
table(base_pronta_growth$ideologia_partido_eleito)
summarytools::freq(base_pronta_growth$ideologia_partido_eleito)
summarytools::descr(base_pronta_growth$margem_vitoria_esquerda, transpose = T, stats = "common", round.digits = 3)
...
p_rdd_object_unconditional_1  <- rdd_data(y = log(despesa_geral_pc), x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
p_rdd_object_unconditional_2  <- rdd_data(y = log(despesa_geral_pib), x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
p_rdd_object_unconditional_3  <- rdd_data(y = log(total_receitas_pc), x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
p_rdd_object_unconditional_4  <- rdd_data(y = log(total_receitas_pib), x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
p_rdd_object_unconditional_5  <- rdd_data(y = log(receita_tributaria_pc), x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
p_rdd_object_unconditional_6  <- rdd_data(y = log(receita_tributaria_pib), x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
p_rdd_object_unconditional_7  <- rdd_data(y = log(servidores_comissionados_mil + 0.0001), x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
p_rdd_object_unconditional_8  <- rdd_data(y = educacao_prop, x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
p_rdd_object_unconditional_9  <- rdd_data(y = saude_prop, x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
p_rdd_object_unconditional_10 <- rdd_data(y = assistencia_social_prop, x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
p_rdd_object_unconditional_11 <- rdd_data(y = urbanismo_prop, x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
p_rdd_object_unconditional_12 <- rdd_data(y = transporte_prop, x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
p_rdd_object_unconditional_13 <- rdd_data(y = desporto_e_lazer_prop, x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
p_rdd_object_unconditional_14 <- rdd_data(y = seguranca_publica_prop, x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
p_rdd_object_unconditional_15 <- rdd_data(y = gestao_ambiental_prop, x = margem_vitoria_esquerda, cutpoint = 0, data = base_pronta_growth)
